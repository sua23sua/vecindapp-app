        ...
        <div className="bg-white rounded-2xl border border-[#E2E8F0] shadow-sm p-6">
          ...
          <div className="space-y-3">
            <Link href="/enviar" className="flex items-center gap-4 p-4 rounded-xl bg-[#1A56DB] text-white hover:bg-[#1A3C6E] transition-colors">
              ...
              <div>
                <p className="font-semibold text-sm">Enviar aviso</p>
                <p className="text-xs text-white/70">Redacta y envía a tus comunidades</p>
              </div>
            </Link>
            <Link href="/comunidades" className="flex items-center gap-4 p-4 rounded-xl border border-[#E2E8F0] hover:bg-[#F8FAFC] transition-colors">
              ...
              <div>
                <p className="font-semibold text-sm text-[#1E293B]">Gestionar comunidades</p>
                <p className="text-xs text-[#475569]">Añade o edita propietarios</p>
              </div>
            </Link>
            <Link href="/seguimiento" className="flex items-center gap-4 p-4 rounded-xl border border-[#E2E8F0] hover:bg-[#F8FAFC] transition-colors">
              ...
              <div>
                <p className="font-semibold text-sm text-[#1E293B]">Ver seguimiento</p>
                <p className="text-xs text-[#475569]">Revisa quién leyó y confirmó</p>
              </div>
            </Link>
          </div>
        </div>
